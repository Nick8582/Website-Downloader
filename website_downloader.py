...
def create_gui():
    ...
    Label(root, text="Save Folder:").pack()
    ...
    Button(root, text="Download", command=lambda: start_download(url_entry.get(), folder_entry.get())).pack()
